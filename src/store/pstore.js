...
export const pStore = defineStore("store-p", () => {
    ...
    const conferenceStore = ref({
        currentHistoryConference: null,
        _reset() {
            this.currentHistoryConference = null;
        },
    });
    return {
        conversationStore,
