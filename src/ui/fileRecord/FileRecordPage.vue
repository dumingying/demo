    ...
    <section>
        <div class="file-record-page">
            ...
            <div class="file-record-container">
                    ...
                    <ul>
                        ...
                        <li>
                            <div
                                class="category-item"
                                v-bind:class="{
                                    active: category === CATEGORY_CONVERSATION,
                                }"
                        ...
                        <li>
                            <div
                                class="category-item"
                                v-bind:class="{
                                    active: category === CATEGORY_SENDER,
                                }"
                                @click="showSenders"
                            >
                ...
                <div
                    v-if="category === CATEGORY_CONVERSATION && !fileQuery"
                ...
                <div
                    v-if="category === CATEGORY_SENDER && !fileQuery"
                    class="conversation-list-container"
                >
                    <!-- 发送者列表-->
                    <UserListVue
                ...
                <div class="file-record-list-container" infinite-wrapper>
                    ...
                    <div v-if="computedFileRecords.length > 0">
                        <ul>
                            <li
                                v-for="fr in computedFileRecords"
                            ...
                            >
                                ...
                                >
                                    <img
                                        :src="
                                            require(`@/assets/images/filetypes/${fr._fileIconName}`)
                                        "
                                        draggable="false"
                                    />
                                    <div class="file-name-sender-container">
                                        ...
                                        <p class="sender single-line">
                                            {{
                                                fr._userDisplayName +
                                                " | " +
                                                fr._conversationDisplayName
                                            }}
                                        </p>
                                    </div>
                                    <div class="file-date-size-container">
                                        <p class="date single-line">
                                            {{ fr._timeStr }}
                                        </p>
                                        <p class="size single-line">
                                            {{ fr._sizeStr }}
                                        </p>
                                    </div>
                                </div>
                        ...
                        >
                            <template #no-more>{{
                                $t("file_record.no_more")
                            }}</template>
                            <template #no-results>{{
                                $t("file_record.all_file_load")
                            }}</template>
                        </infinite-loading>
                    </div>
                    <div v-else class="file-record-empty-container">
                        {{ emptyDesc }}
                    </div>
                </div>
            </div>
    ...
    methods: {
        ...
        showConversationFiles(conversation, force = false) {
            if (
                ...
                this.currentConversation.equal(conversation)
            ) {
                return;
            }
        ...
        getConversationFileRecords(conversation, fromUser) {
            this.fileRecords = [];
            store.getConversationFileRecords(
                conversation,
                fromUser,
                0,
                20,
        ...
        infiniteHandler($state) {
            let lastMessageUid =
                this.fileRecords.length > 0
                    ? this.fileRecords[this.fileRecords.length - 1].messageUid
                    : 0;
            ...
            switch (this.category) {
                ...
                case this.CATEGORY_CONVERSATION:
                    identifier =
                        ...
                        "-" +
                        this.currentConversation.target +
                        "-" +
                        this.currentConversation.line;
                    break;
                case this.CATEGORY_SENDER:
