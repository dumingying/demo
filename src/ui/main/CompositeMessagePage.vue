        ...
        <div class="message-container">
          <div class="portrait-container">
            <img
              v-if="
                index === 0 ||
                message.from !== compositeMessage.messageContent.messages[index - 1].from
              "
              draggable="false"
...
export default {
  ...
  methods: {
    hideCompositeMessagePage() {
      this.$modal.hide(
        "show-composite-message-modal" + "-" + stringValue(this.message.messageUid)
      );
    },
