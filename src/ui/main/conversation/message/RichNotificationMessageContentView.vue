    ...
    <div style="display: flex; justify-content: center">
        <div class="notification-container" @click="onClickRichNotification">
            ...
            <div v-if="message.messageContent.datas">
                <div
                    v-for="(data, index) in message.messageContent.datas"
                    :key="index"
                    class="data"
                >
    ...
    methods: {
        onClickRichNotification() {
            ...
            if (isElectron()) {
                ...
                if (hash) {
                    url = window.location.href.replace(hash, "#/web3");
                } else {
                    url += "/web3";
                }
                ...
                url +=
                    "?url=" +
                    encodeURIComponent(this.message.messageContent.exUrl);

                ipcRenderer.send(IpcEventType.OPEN_H5_APP_WINDOW, {
