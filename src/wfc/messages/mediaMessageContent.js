...
export default class MediaMessageContent extends MessageContent {
    ...
    constructor(messageType, mediaType = 0, fileOrLocalPath, remotePath) {
        ...
        if (!fileOrLocalPath) {
            ...
            typeof fileOrLocalPath === "string" &&
            !fileOrLocalPath.startsWith("http")
        ) {
    ...
    encode() {
        ...
        payload.imFileName = this.imFileName;
        payload.imFileSize = this.imFileSize;
        payload.fromDiskShare = this.fromDiskShare;
        return payload;
    }
